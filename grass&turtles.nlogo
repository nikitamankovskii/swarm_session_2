...
to setup-turtles
  create-turtles 50    ;; uses the value of the number slider to create turtles
...
to reproduce
  ask turtles [
    if energy > 50 [
      ...
      hatch 1 [ set energy 50 ] ;; give this birth-energy to the offspring
    ]
  ]
end
...
"gras" 1.0 0 -13840069 true "" "plot count patches with [pcolor = green]"
